  ...
  <div>
    ...
    <p>
      ...
      <a
        ...
        target="_blank"
        >this spreadsheet</a
      >, which includes links to players' USCF profiles and the ability to sort
      by different columns. There is also another tab on that spreadsheet that
      details the current prize fund. If you believe there to be an error in the
      standings, please reach out to Joseph Truelson.
    </p>
  </div>
...
export default {
  ...
  async created() {
    const response = await axios.get(
      "https://sheets.googleapis.com/v4/spreadsheets/1sUah6u_FEgw35qm7nhImlAmHUlXG5V3zD0vq2hqaI00/values/Standings!A1:F40",
      {
        params: {
